...
from typing import Literal, List, Any, TypedDict, Union
...
class FunctionCall(TypedDict):
    name: str
    arguments: str  # JSON string of arguments e.g. '{"city": "San Francisco"}' , it is the string with the ' it is not a dict
...
class ToolResponseMessage(BaseModel):
    ...
    name: str
    content: str
    tool_call_id: str  # This is the id of the tool call, it is used to link the response with the tool call
