...
def factory_documents_retrieval_tool(
    ...
    **kwargs: dict,  # type: ignore
    ...
    """Factory function to create a documents retrieval tool."""

    @tool
    def documents_retrieval_tool(
        user_input: Annotated[str, "The description of the documents the user wants to retrieve"],
...
def RETRIEVAL_STRATEGY_WKARGS_MAP(QueryServiceWargs: dict) -> object:  ## type: ignore
    """Return the retrieval strategy and its kwargs based on the QueryServiceWargs.

    This takes the QueryServiceWargs and loads it to instantiate the retrieval strategy
    """
...
if __name__ == "__main__":  # pragma: no cover
    ...
    load_documents_tool: BaseTool = factory_documents_retrieval_tool(
        retrieval_strategy=ExactMatchRetrievalStrategy, document_retriever=OfflineDocumentLoader()
    )
