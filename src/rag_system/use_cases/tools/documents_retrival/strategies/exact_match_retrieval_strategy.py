...
class ExactMatchRetrievalStrategy(BaseQuestionClassifier):
    """Retrieve documents using exact match strategy."""

    def __init__(self, document_loader: BaseDocumentLoader):
        """Initialize the retrieval strategy with a document loader."""
        self.document_loader = document_loader

    def classify(self, question: str) -> Document | EmptyResponse:
        """Retrieve document by finding an exact match in the example questions."""
