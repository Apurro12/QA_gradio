...
def test_offline_agent_find_response(offline_agent: BaseAgent):
    ...
    expected_offline_response = "[OFFLINE ANSWER GENERATOR] [OFFLINE LLM CALL]"
...
def test_chat_with_conversation_manager_with_context(
    offline_agent_with_conversation_manager: Agent,
):
    empty_history: list[Message] = []
...
def test_chat_with_conversation_manager_with_history(
    offline_agent_with_conversation_manager: Agent,
):
...
def test_chat_with_conversation_manager_with_history_and_context(
    offline_agent_with_conversation_manager: Agent,
):
    history: list[Message] = [
        Message(role="user", content="Message1"),
